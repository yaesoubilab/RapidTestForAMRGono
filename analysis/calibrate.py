...
N_OF_TRAJS_TO_USE_FOR_SIMULATION = 8*1   # number of trajectories with the highest likelihood to keep
N_OF_RESAMPLES_FOR_PARAM_ESTIMATION = 8*1  # number of parameter values to resample for parameter estimation
