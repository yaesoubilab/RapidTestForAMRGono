...
N_OF_CALIBRATION_ITERATIONS = 16    # total number of trajectories to simulate as part of calibration
N_OF_TRAJS_TO_USE_FOR_SIMULATION = 4   # number of trajectories with the highest likelihood to keep
N_OF_RESAMPLES_FOR_PARAM_ESTIMATION = 4  # number of parameter values to resample for parameter estimation
