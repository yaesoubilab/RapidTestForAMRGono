...
N_OF_TRAJS_TO_USE_FOR_SIMULATION = 16*5   # number of trajectories with the highest likelihood to keep
N_OF_RESAMPLES_FOR_PARAM_ESTIMATION = 16*5  # number of parameter values to resample for parameter estimation
